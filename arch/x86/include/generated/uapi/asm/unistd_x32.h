...
#define __NR_shar_test_sys (__X32_SYSCALL_BIT + 316)
#define __NR_shar_rdmsr (__X32_SYSCALL_BIT + 317)
#define __NR_shar_wrmsr (__X32_SYSCALL_BIT + 318)
#define __NR_shar_prog (__X32_SYSCALL_BIT + 319)
